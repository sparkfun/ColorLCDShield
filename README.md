...
NOTE: This faster version only supports the Phillips display, and requires that you use SPI. Bitbanging data sucks, and it is slow. There are also several speedup enhancements.
